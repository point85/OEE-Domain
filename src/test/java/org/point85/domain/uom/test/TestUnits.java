...
public class TestUnits extends BaseTest {
	...
	public void testBaseSymbols() throws Exception {
		...
		assertTrue(symbol.equals("1/s") || symbol.equals("Bq"));
	...
	public void testMeasurementTypes() throws Exception {
		...
		assertTrue(m.getMeasurementType().equals(MeasurementType.SCALAR));
		assertTrue(mps.getMeasurementType().equals(MeasurementType.QUOTIENT));
		assertTrue(n.getMeasurementType().equals(MeasurementType.PRODUCT));
		assertTrue(a.getMeasurementType().equals(MeasurementType.POWER));
	}
